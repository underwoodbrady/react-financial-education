...
import ArticleOne from "../screens/learn/Article1";
import ArticleTwo from "../screens/learn/Article2";
import GoBackShowModal from "../components/header/GoBackShowModal";
...
const LearningStack = () => (
    <Stack.Navigator screenOptions={{
        ...
        <Stack.Screen name="Savings Matching One" component={SavingsMatchingOne} options={{
            headerLeft: () => <GoBackShowModal/>
        }}/>
        <Stack.Screen name="50-30-20 Budget" component={FiftyThirtyTwentyBudgeting} options={{
            headerLeft: () => <GoBackShowModal/>
        }}/>
        <Stack.Screen name="Budgeting Article" component={ArticleOne}/>
        <Stack.Screen name="Savings Article" component={ArticleTwo}/>
